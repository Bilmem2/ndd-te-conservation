...
This repository contains all analysis scripts, processed gene lists, statistical results, and figures for the above manuscript. Raw genome assemblies and RepeatMasker annotation files are not included due to size constraints; download instructions are provided below.
...
│   ├── statistics_ortholog.csv        # Validation: Ensembl 1:1 ortholog-based matching
│   ├── null_model_new.csv             # Permutation test results (n=10,000)
│   ├── sensitivity/
│   │   └── window_sensitivity.csv     # Effect sizes at ± 0.5, 1, 2, 3 kb windows
│   └── cross_disease/
...
# 8. Final statistics across all 7 species
python scripts/11_stats_updated.py

# 9. Generate manuscript figures (Fig 1–5)
